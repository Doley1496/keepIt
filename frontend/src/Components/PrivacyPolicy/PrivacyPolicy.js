...
const Policy = () => {
  ...
  */
  return (
    // Using SEO in Policy.js page now title will be shown as Privacy Policy Page
    <Layout title={"Privacy Policy"}>
      {/* Using grid to separate the contents in two parts 1st part contains image and 2nd part contains some text */}
      ...
      <div className="col-md-10">
        ...
        <div className="space">
          <h1 className="text-center mb-5 under">Privacy Policy</h1>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to keepIt.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>
              By email: madhurdoley1496@gmail.com
              {/* <a href="http://gmail.com" target="_blank">
                madhurdoley1496@gmail.com
              </a> */}
            </li>
          </ul>
        </div>
